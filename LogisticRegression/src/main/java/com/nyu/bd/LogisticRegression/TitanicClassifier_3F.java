...
public class TitanicClassifier_3F {
	...
	public static void main(String[] args) throws IOException {
        ...
        for(int i = 0; i < n; i++) {
        		JavaRDD<LabeledPoint>[] split = oriLP.randomSplit(new double[] {0.67, 0.33}, 17);
        ...
        File file = new File("/home/2018/spring/nyu/6513/sy2160/Finals/P3/result/3_Fold.txt");
