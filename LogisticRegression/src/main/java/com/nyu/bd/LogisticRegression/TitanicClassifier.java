...
public class TitanicClassifier {
	...
	public static void main(String[] args) throws IOException {
        SparkConf conf = new SparkConf().setAppName("Finals P3 Logistic Regression").setMaster("local[1]");
        ...
        for(int i = 0; i < n; i++) {
        		List<LabeledPoint> oriLP_array = oriLP.collect();
            List<LabeledPoint> testData_array = new LinkedList<LabeledPoint>();
            testData_array.add(oriLP_array.get(i));
            JavaRDD<LabeledPoint> test = sc.parallelize(testData_array);
            List<LabeledPoint> trainData_array = new LinkedList<LabeledPoint>(oriLP_array);
            trainData_array.remove(i);
            JavaRDD<LabeledPoint> training = sc.parallelize(trainData_array);
        ...
        File file = new File("/home/2018/spring/nyu/6513/sy2160/Finals/P3/result/LOOCV.txt");
