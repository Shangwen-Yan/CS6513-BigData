...
public class TitanicClassifier_10F {
	...
	public static void main(String[] args) throws IOException {
        ...
        JavaRDD<String>[] split = oriData.randomSplit(new double[] {0.9, 0.1}, 17);
        ...
        File file = new File("/home/2018/spring/nyu/6513/sy2160/Finals/P3/result/10_Fold.txt");
        FileOutputStream fos = new FileOutputStream(file);
        String content = "total train data:" + training.count()+"\n";
        content += "total test :" + test.count() +"\n";
        content += "seed:" + "17"+"\n";
